...
\begin{center}
    ...
    \hline
     ...
     time(s)    &197.1732 & 311.559 & 97.1395 &90.618 &88.744 & 92.4798 &74.2186  &199.893 \\
  \hline
...
\begin{center}
    ...
    \begin{tabular}{p{3.0cm} p{1.55cm} p{1.3cm} p{1.3cm} p{1.3cm} p{1.35cm} p{1.5cm} p{1.5cm}p{1.4cm}}

    \hline

     Models& Tree& Armadillo& Octopus& Deer& Airplane& Knots &Sculpture & Gargoyle\\ \hline
     tested number  & 5 (4)   & 8   & 4    & 3  & 4 (3) & 9   & 3    &3 \\ \hline
     feasibility    & YES (NO)   & NA & NO & NO &YES (NO) & NO & NO & NO  \\ \hline
     time(core*hour)    &62.72 (67.84) & 4285.44 & 8.8 &0.01 &0.1 (0.2) & 7870.08 &0.16  &0.1 \\ \hline
...
From Table \ref{tab:ertms:super}, we can see that 
