...
\begin{figure}[tbp]
  \centering
  \includegraphics[width=0.4\textwidth]{figs/simpletree.png}
  \caption{\label{fig:simpletree}%
           An illustration of an 8-shaped model and a simplified tree model that are partitioned into the least pieces by our algorithm. The printing directions are indicated by arrows.}
\end{figure}
