...
{\color{red} {Occasionally, there are cases where two subgraphs intersect at some interior node, then their corresponding mesh components need to be separated by an additional cut.} {See Figure \ref{fig:super_tree} for an example. For the cross of the red and blue subgraphs, two cuts are required to separate the their corresponding mesh components. }}
