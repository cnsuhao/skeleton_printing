...
{\color{red} {Particularly, as an interior node (rather than nay end node) of a subgraph coincides with the interior node of another subgraph, then their corresponding mesh components need to be separated by two cuts.}}
