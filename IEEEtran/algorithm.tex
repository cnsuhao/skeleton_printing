...
{\color{red} {Occasionally, there are cases where an two subgraphs intersect at interior nodes, then their corresponding mesh components need to be separated by an additional cut.} {See Figure \ref{fig:super_tree} for an example. For the cross of the red and blue subgraphs, two more cuts are required to separate the their corresponding mesh components. }}
