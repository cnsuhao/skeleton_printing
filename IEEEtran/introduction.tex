...
\begin{figure*}[t]
  ...
  A deer model is partitioned into support-free parts using our algorithm: (a) a mesh model (hollow); (b) skeleton partition by our approach; (c)mesh partition by our approach;the support-free printing of the parts; (d) the assembly result of the printed parts.}
\end{figure*}
