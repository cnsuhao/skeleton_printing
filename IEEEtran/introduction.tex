...
\begin{figure}[t!]
  ...
  (a) A solid pyramid used in \cite{Hu_siga14}, and (b) a shell version of the model. The former can be printed in a support-free manner, while {\color{blue}the top region} of the latter needs support from below.}
\end{figure}
