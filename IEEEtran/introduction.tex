...
\begin{figure}[t!]
  ...
  (a) A solid pyramid used in \cite{Hu_siga14}, and (b) a shell version of the model, {\color{red}where the overhang region is highlighted in red}. The former can be printed in a support-free manner, while the overhang region of the latter needs support from below.}
\end{figure}
...
{\color{red}The remainder of the paper is organized as follows: Section 2 provides a review of the related works, section 3 provides a closed-form solution to the problem, section 4 provides a stochastic method for the problem, section 5 provides the experimental results of our proposed methods, section 6 concludes the paper with some discussions.}
