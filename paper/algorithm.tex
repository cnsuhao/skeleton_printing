...
Then randomly sample a set of cutting planes from $(fillet(Hi) \cap Fillet(Hj)) / {v}$, and determine the one achieving the minimum cutting length $(fillet(H_i) ¡É fillet(H_j)) = {v}$.
