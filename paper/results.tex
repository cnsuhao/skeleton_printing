...
\begin{figure}[tbp]
  ...
  \caption{\label{fig:programming}%
           Partition examples as the support angle is no larger than $20^{\circ}$. The printing direction of each part is orthogonal to its base (shown in the same color as the part)}
\end{figure}
